...
namespace FuzztMatching.Core.FeatureMatrixCalculation
{
    public static class NGramsCalculator
    {
        ...
        /// <returns></returns>
        public static string[] GetSentenceNGrams(string sentence, int ngramsLength = 3)
        {
        ...
        public static string[][] GetSentenceNGramsBatch(List<string> sentenceList, int ngramsLength = 3)
        {
            return sentenceList.Select(sentence => GetSentenceNGrams(sentence, ngramsLength)).ToArray();
        }
